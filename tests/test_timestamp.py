...
def create_rdmfiletimestamptokenverifyresult(self, filename='test_file_timestamp_check', provider='osfstorage', inspection_result_status_1=True):
    ...
    with open(tmp_file, 'wb') as fout:
        fout.write('filename:{}, provider:{}, inspection_result_status_1(true:1 or false:3):{}'.format(filename.encode('utf-8'), provider.encode('utf-8'), inspection_result_status_1))
